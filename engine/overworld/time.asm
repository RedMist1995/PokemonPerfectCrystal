...
StartSafariZoneTimer:
	ld a, SAFARI_ZONE_MINUTES
	ld [wSafariZoneMinsRemaining], a
	ld a, SAFARI_ZONE_SECONDS
	ld [wSafariZoneSecsRemaining], a
	call UpdateTime
	ld hl, wSafariZoneStartTime
	call CopyDayHourMinSecToHL
	ret

CheckSafariZoneTimer::
	ld hl, wSafariZoneStartTime
	call CalcSecsMinsHoursDaysSince
	ld a, [wDaysSince]
	and a
