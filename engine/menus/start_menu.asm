; StartMenu.Items indexes
	...
	const STARTMENUITEMSAFARI_QUIT ; 9
...
StartMenu::
	...
	ld hl, wStatusFlags2
	bit STATUSFLAGS2_SAFARI_GAME_TIMER_F, [hl]
	ld hl, .MenuHeader
	jr z, .GotMenuData
...
; entries correspond to STARTMENUITEM_* constants
	...
	dw StartMenuSafari_Quit, .QuitString,   .QuitDesc
...
StartMenuSafari_Quit:
; Retire from the bug catching contest.

	ld hl, .EndTheSafariText
	call StartMenuYesNo
	jr c, .DontEndSafari
