...
PewterCityGrampsScript:
	...
	special BirdsCheck
	iffalse .CatchBirds
	writetext PewterCityGrampText_GiveSilverWing
	buttonsound
...
.CatchBirds:
	writetext PewterCityGrampsText_CatchBirds
	waitbutton
	closetext
	end
...
PewterCityGrampsText_CatchBirds:
	...
	para "In my travels I "
	line "heard tale of "
	
	para "JOHTO's trio of "
	line "legendary #MON. "
	
	para "We used to have "
	line "similar legends"
	cont "here in KANTO. "
	done

PewterCityGrampText_GiveSilverWing:
	text "Ah, you came all"
	line "the way out here"
	cont "from JOHTO?"
