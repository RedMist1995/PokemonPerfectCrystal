...
HonogumaBitmasks:   INCLUDE "gfx/pokemon/honoguma/bitmask.asm"
BearcanoBitmasks:   INCLUDE "gfx/pokemon/bearcano/bitmask.asm"
DynabearBitmasks:   INCLUDE "gfx/pokemon/dynabear/bitmask.asm"
CruiseBitmasks:     INCLUDE "gfx/pokemon/cruise/bitmask.asm"
AquaBitmasks:       INCLUDE "gfx/pokemon/aqua/bitmask.asm"
