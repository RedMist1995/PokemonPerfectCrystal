...
wEveEncounterRate::   db ; d25d
wWaterEncounterRate:: db ; d25e
...
wSafariZoneGateSceneID::                          db ; d9c1
...
SECTION "Safari Zone RAM", WRAMX
wSafariMonAngerCount:: db
wSafariMonEating:: db
	ds 1

;safari zone timer
wSafariZoneMinsRemaining:: db
wSafariZoneSecsRemaining:: db
	ds 2

wParkBallsRemaining::
wSafariBallsRemaining:: db ; dc79
wSafariTimeRemaining:: dw ; dc7a
wSafariZoneStartTime:: ds 4 ; day, hour, min, sec
wSafariZoneFirstPartySpecies:: db
wSafariMon:: party_struct wSafariMon ; df9c
