...
; - scripts and events (see data/maps/scripts.asm)
	...
	newgroup SEAFOAM_ISLANDS									  ; 27

	map_const SEAFOAM_ENTRANCE,                             5,  4 ;  1
	map_const SEAFOAM_GYM,                                  5,  4 ;  2

	newgroup SAFARI_ZONE										  ; 28
	map_const SAFARI_ZONE_FUCHSIA_GATE,                     3,  4 ;  1
	map_const SAFARI_ZONE_CENTER,                          15, 12 ;  2
	map_const SAFARI_ZONE_EAST,                            12, 10 ;  3
	map_const SAFARI_ZONE_NORTH,                           15, 14 ;  4
	map_const SAFARI_ZONE_WEST,                            12, 10 ;  5
