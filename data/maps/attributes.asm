...
ENDM
	...
	map_attributes SeafoamEntrance, SEAFOAM_ENTRANCE, $09, 0
	map_attributes SeafoamGym, SEAFOAM_GYM, $09, 0

	map_attributes SafariZoneFuchsiaGate, SAFARI_ZONE_FUCHSIA_GATE, $00, 0
	map_attributes SafariZoneCenter, SAFARI_ZONE_CENTER, $13, 0
	map_attributes SafariZoneEast, SAFARI_ZONE_EAST, $00, 0
	map_attributes SafariZoneNorth, SAFARI_ZONE_NORTH, $05, 0
	map_attributes SafariZoneWest, SAFARI_ZONE_WEST, $09, 0
