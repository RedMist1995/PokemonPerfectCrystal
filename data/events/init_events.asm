InitialEvents:
    ...
    dw EVENT_POWERPLANT_ZAPDOS
	dw EVENT_SEAFOAM_ARTICUNO
	dw EVENT_VICTORY_ROAD_MOLTRES
    ...
    dw EVENT_SET_WHEN_FOUGHT_ZAPDOS
    dw EVENT_SET_WHEN_FOUGHT_ARTICUNO
    dw EVENT_SET_WHEN_FOUGHT_MOLTRES
    dw EVENT_SAW_SUICUNE_ON_ROUTE_36
    dw EVENT_SAW_SUICUNE_ON_ROUTE_42
    dw EVENT_SAW_SUICUNE_AT_CIANWOOD_CITY
    dw EVENT_BATTLE_TOWER_OUTSIDE_SAILOR
